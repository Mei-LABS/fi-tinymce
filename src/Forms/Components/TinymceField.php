...
namespace MeiLABS\TinyMCE\Forms\Components;
...
class TinymceField extends Field implements Contracts\CanBeLengthConstrained, Contracts\HasFileAttachments
{
    ...
    protected string $view = 'mei-labs-tinymce::forms.components.tinymce-field';
    ...
    {
        if (config('mei-labs-tinymce.profiles.' . $this->profile . '.toolbar')) {
            return config('mei-labs-tinymce.profiles.' . $this->profile . '.toolbar');
        }
    ...
    {
        if (config('mei-labs-tinymce.profiles.' . $this->profile . '.plugins')) {
            return config('mei-labs-tinymce.profiles.' . $this->profile . '.plugins');
        }
    ...
    {
        return filled($directory = $this->evaluate($this->fileAttachmentsDirectory)) ? $directory : config('mei-labs-tinymce.profiles.' . $this->profile . '.upload_directory');
    }
    ...
    {
        if (config('mei-labs-tinymce.content_css')) {
            return config('mei-labs-tinymce.content_css');
        }
    ...
    {
        return config('mei-labs-tinymce.file_manager');
    }
}
